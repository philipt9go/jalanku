...
const ORIGINS = [
  "Ampang", "Bukit Jalil", "Cheras", "Gombak", "Kajang",
  "Kepong", "Kuchai Lama", "Puchong", "Putrajaya", "Shah Alam", "Subang Jaya",
]

const DESTINATIONS_BY_ORIGIN: Record<string, string[]> = {
  "Ampang":      ["Ampang Park", "Bukit Bintang", "Bukit Jalil", "KL Sentral", "KLCC", "Kuchai Lama", "Midvalley", "TRX"],
  "Bukit Jalil": ["Ampang Park", "Bangsar", "Bukit Bintang", "KL Sentral", "KLCC", "Midvalley", "PNB 118", "Subang", "Sunway", "TRX"],
  "Cheras":      ["Ampang Park", "Bukit Bintang", "Bukit Jalil", "KL Sentral", "KLCC", "Kuchai Lama", "Midvalley", "PNB 118", "Subang", "Sunway", "TRX"],
  "Gombak":      ["Ampang Park", "Bukit Bintang", "Bukit Jalil", "KL Sentral", "KLCC", "Midvalley", "TRX"],
  "Kajang":      ["Bukit Bintang", "Bukit Jalil", "KL Sentral", "KLCC", "Midvalley", "TRX"],
  "Kepong":      ["Ampang Park", "Bukit Bintang", "Bukit Jalil", "KL Sentral", "KLCC", "Kuchai Lama", "Midvalley", "PNB 118", "Petaling Jaya", "Subang", "Sunway", "TRX"],
  "Kuchai Lama": ["Bangsar", "Bukit Bintang", "KL Sentral", "KLCC", "Midvalley", "Petaling Jaya", "TRX"],
  "Puchong":     ["Ampang Park", "Bangsar", "Bukit Bintang", "Bukit Jalil", "KL Sentral", "KLCC", "Kuchai Lama", "Midvalley", "PNB 118", "Petaling Jaya", "Sunway", "TRX"],
  "Putrajaya":   ["Bangsar", "Cyberjaya", "KL Sentral", "KLCC", "TRX"],
  "Shah Alam":   ["KL Sentral", "KLCC", "Kuchai Lama", "Petaling Jaya", "Sunway", "TRX"],
  "Subang Jaya": ["Ampang Park", "Bangsar", "Bukit Jalil", "KL Sentral", "KLCC", "Kuchai Lama", "Midvalley", "PNB 118", "Petaling Jaya", "Subang", "Sunway", "TRX"],
}

const ROUTE_IDS: Record<string, string> = {
  "Ampang|Ampang Park":           "ampang-klcc", // fallback
  "Ampang|Bukit Bintang":         "ampang-bukit-bintang",
  "Ampang|Bukit Jalil":           "ampang-bukit-jalil",
  ...
  "Ampang|TRX":                   "ampang-trx",
  "Bukit Jalil|Ampang Park":      "bukit-jalil-ampang-park",
  "Bukit Jalil|Bangsar":          "bukit-jalil-bangsar",
  "Bukit Jalil|Bukit Bintang":    "bukit-jalil-bukit-bintang",
  "Bukit Jalil|KL Sentral":       "bukit-jalil-kl-sentral",
  "Bukit Jalil|KLCC":             "bukit-jalil-klcc",
  "Bukit Jalil|Midvalley":        "bukit-jalil-midvalley",
  "Bukit Jalil|PNB 118":          "bukit-jalil-pnb118",
  "Bukit Jalil|Subang":           "bukit-jalil-subang",
  "Bukit Jalil|Sunway":           "bukit-jalil-sunway",
  "Bukit Jalil|TRX":              "bukit-jalil-trx",
  "Cheras|Ampang Park":           "cheras-ampang-park",
  "Cheras|Bukit Bintang":         "cheras-bukit-bintang",
  "Cheras|Bukit Jalil":           "cheras-bukit-jalil",
  ...
  "Cheras|PNB 118":               "cheras-pnb118",
  "Cheras|Subang":                "cheras-subang",
  "Cheras|Sunway":                "cheras-sunway",
  "Cheras|TRX":                   "cheras-trx",
  "Gombak|Ampang Park":           "gombak-ampang-park",
  "Gombak|Bukit Bintang":         "gombak-bukit-bintang",
  "Gombak|Bukit Jalil":           "gombak-bukit-jalil",
  "Gombak|KL Sentral":            "gombak-kl-sentral",
  "Gombak|KLCC":                  "gombak-klcc",
  "Gombak|Midvalley":             "gombak-midvalley",
  "Gombak|TRX":                   "gombak-trx",
  "Kajang|Bukit Bintang":         "kajang-bukit-bintang",
  "Kajang|Bukit Jalil":           "kajang-bukit-jalil",
  "Kajang|KL Sentral":            "kajang-kl-sentral",
  "Kajang|KLCC":                  "kajang-klcc",
  "Kajang|Midvalley":             "kajang-midvalley",
  "Kajang|TRX":                   "kajang-trx",
  "Kepong|Ampang Park":           "kepong-ampang-park",
  "Kepong|Bukit Bintang":         "kepong-bukit-bintang",
  "Kepong|Bukit Jalil":           "kepong-bukit-jalil",
  ...
  "Kepong|PNB 118":               "kepong-pnb118",
  "Kepong|Petaling Jaya":         "kepong-pj",
  "Kepong|Subang":                "kepong-subang",
  "Kepong|Sunway":                "kepong-sunway",
  "Kepong|TRX":                   "kepong-trx",
  ...
  "Kuchai Lama|TRX":              "kuchai-lama-trx",
  "Puchong|Ampang Park":          "puchong-ampang-park",
  "Puchong|Bangsar":              "puchong-bangsar",
  "Puchong|Bukit Bintang":        "puchong-bukit-bintang",
  "Puchong|Bukit Jalil":          "puchong-bukit-jalil",
  ...
  "Puchong|PNB 118":              "puchong-pnb118",
  "Puchong|Petaling Jaya":        "puchong-pj",
  "Puchong|Sunway":               "puchong-sunway",
  "Puchong|TRX":                  "puchong-trx",
  ...
  "Shah Alam|Sunway":             "shah-alam-sunway",
  "Shah Alam|TRX":                "shah-alam-trx",
  "Subang Jaya|Ampang Park":      "subang-jaya-ampang-park",
  "Subang Jaya|Bangsar":          "subang-jaya-bangsar",
  "Subang Jaya|Bukit Jalil":      "subang-jaya-bukit-jalil",
  ...
  "Subang Jaya|PNB 118":          "subang-jaya-pnb118",
  "Subang Jaya|Petaling Jaya":    "subang-jaya-pj",
  "Subang Jaya|Subang":           "subang-jaya-klcc",
  "Subang Jaya|Sunway":           "subang-jaya-sunway",
  "Subang Jaya|TRX":              "subang-jaya-trx",
}
